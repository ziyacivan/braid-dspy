                ...
                if self.use_dspy_predict:
                    ...
                    if not lm:
                        ...
                        try:
                            ...
                            raise ValueError("DSPy language model not configured. Call dspy.configure(lm=...) first.")
                    ...
                    try:
                        response = lm(prompt)
                        raw_response = response if isinstance(response, str) else getattr(response, 'text', str(response))
                    finally:
