...
latex_documents = [
    (master_doc, "braid-dspy.tex", "BRAID-DSPy Documentation", "Braid-DSPy Contributors", "manual"),
]

# -- Options for manual page output ------------------------------------------
man_pages = [(master_doc, "braid-dspy", "BRAID-DSPy Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "braid-dspy",
        "BRAID integration for DSPy framework",
        "Miscellaneous",
    ),
]
